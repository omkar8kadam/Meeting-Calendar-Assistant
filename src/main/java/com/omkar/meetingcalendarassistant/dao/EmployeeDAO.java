...
public class EmployeeDAO {
    ...
    static {
        ...
        employeeList.add(new Employee(2L, "Omkar"));
        employeeMap.put(2L, 1);
        employeeList.add(new Employee(3L, "Omkar"));
        employeeMap.put(3L, 2);
        employeeList.add(new Employee(4L, "Omkar"));
        employeeMap.put(4L, 3);
        employeeList.add(new Employee(5L, "Omkar"));
        employeeMap.put(5L, 4);
    }

    public Long createEmployee(Long id, String name) {
        if (employeeMap.containsKey(id))
            throw new CustomExcpetion("Invalid Input", "Employee id already present");
